...
(function (L10_Vogelhaus_Polymorphie) {
    ...
    function handleLoad(_event) {
        ...
        landscape = L10_Vogelhaus_Polymorphie.ctx.getImageData(0, 0, canvas.width, canvas.height);
        L10_Vogelhaus_Polymorphie.ctx.restore();
        setInterval(update, 100);
    }
    function create() {
        for (let index = 0; index < 100; index++) {
            let snowflake = new L10_Vogelhaus_Polymorphie.Snowflake(1);
            moveables.push(snowflake);
        }
        for (let index2 = 0; index2 < 20; index2++) {
            let bird = new L10_Vogelhaus_Polymorphie.Birds(40);
            moveables.push(bird);
        }
    }
    ...
    function update() {
        console.log("update");
        L10_Vogelhaus_Polymorphie.ctx.putImageData(0, 0);
    ...
    //     }}
    function update() {
        L10_Vogelhaus_Polymorphie.ctx.clearRect(0, 0, L10_Vogelhaus_Polymorphie.ctx.canvas.width, L10_Vogelhaus_Polymorphie.ctx.canvas.height);
