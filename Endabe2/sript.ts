...
//Globale Variablen/ Interface für Fragen(gibt Struktur meiner Fragen vor)/ Question Array für Fragen/ Buttonactive für Button/ Array für gemischt Karten
...
function navigateToGame(_Thema:Question []): void {
    ...
    buttonA = document.getElementById("A") as HTMLButtonElement;
    buttonB = document.getElementById("B") as HTMLButtonElement;
